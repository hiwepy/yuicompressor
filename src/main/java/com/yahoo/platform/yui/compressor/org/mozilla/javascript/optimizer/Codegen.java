...
package com.yahoo.platform.yui.compressor.org.mozilla.javascript.optimizer;
...
import com.yahoo.platform.yui.compressor.org.mozilla.classfile.ByteCode;
import com.yahoo.platform.yui.compressor.org.mozilla.classfile.ClassFileWriter;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.CompilerEnvirons;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.Context;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.Evaluator;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.Function;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.FunctionNode;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.GeneratedClassLoader;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.Kit;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.NativeFunction;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.NativeGenerator;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.Node;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.ObjArray;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.ObjToIntMap;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.RhinoException;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.Script;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.ScriptOrFnNode;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.ScriptRuntime;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.Scriptable;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.SecurityController;
import com.yahoo.platform.yui.compressor.org.mozilla.javascript.Token;
...
public class Codegen implements Evaluator
{
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("com/yahoo/platform/yui/compressor/org/mozilla/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                "com/yahoo/platform/yui/compressor/org/mozilla/javascript/BaseFunction",
                      "createObject",
        ...
        cfw.add(ByteCode.INSTANCEOF, "com/yahoo/platform/yui/compressor/org/mozilla/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "com/yahoo/platform/yui/compressor/org/mozilla/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                "com/yahoo/platform/yui/compressor/org/mozilla/javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Lorg/mozilla/javascript/Context;"
                      +")Z");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                "com/yahoo/platform/yui/compressor/org/mozilla/javascript/NativeFunction",
                      "initScriptFunction",
                      "(Lorg/mozilla/javascript/Context;"
                      +"Lorg/mozilla/javascript/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                        "com/yahoo/platform/yui/compressor/org/mozilla/javascript/RegExpProxy",
                              "compileRegExp",
                              "(Lorg/mozilla/javascript/Context;"
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "com/yahoo/platform/yui/compressor/org/mozilla/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "com/yahoo/platform/yui/compressor/org/mozilla/javascript/Undefined",
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
                ...
                || fnCurrent.fnode.getIgnoreDynamicScope()))
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                    "com/yahoo/platform/yui/compressor/org/mozilla/javascript/Scriptable",
                          "getParentScope",
                          "()Lorg/mozilla/javascript/Scriptable;");
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                "com/yahoo/platform/yui/compressor/org/mozilla/javascript/JavaScriptException");
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                    "com/yahoo/platform/yui/compressor/org/mozilla/javascript/Callable",
                "call",
                "(Lorg/mozilla/javascript/Context;"
                +"Lorg/mozilla/javascript/Scriptable;"
                +"Lorg/mozilla/javascript/Scriptable;"
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "com/yahoo/platform/yui/compressor/org/mozilla/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "com/yahoo/platform/yui/compressor/org/mozilla/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            exceptionName = "com/yahoo/platform/yui/compressor/org/mozilla/javascript/EcmaError";
